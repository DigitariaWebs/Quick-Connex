        ...
        <div className="glass-morphism rounded-xl overflow-hidden shadow-2xl">
          ...
          <div className="p-6">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <RoleSpecificFields role="employee" currentRole={userType}>
                <FileUpload
                  id="opiqPermit"
                  name="opiqPermit"
                  label="OPIQ Permit"
                />
                <FileUpload id="rcr" name="rcr" label="RCR Document" />
              </RoleSpecificFields>

              {/* Manager Specific Fields */}
              <RoleSpecificFields role="manager" currentRole={userType}>
                <FormInput
                  id="post"
                  name="post"
                  label="Post"
