 ...
 * 
 * JWT functions that can be used in Edge Runtime (middleware) without
 * importing the full auth module or any mongoose dependencies.
 */
...
// Standalone TokenPayload interface (copied from core/types to avoid circular imports)
