  ...
  private async getDefaultTemplates(): Promise<CommunicationTemplate[]> {
    return [
      ...
      },
      {
        ...
        channel: 'sms',
        category: 'reminder',
        text: 'Reminder: Transfer for {{patientName}} scheduled for {{scheduledDate}} from {{fromHospital}} to {{toHospital}}',
        variables: ['patientName', 'scheduledDate', 'fromHospital', 'toHospital'],
        isActive: true,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
