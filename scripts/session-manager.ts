...
class SessionManager {
  ...
  async connect() {
    ...
    // Register models
    DatabaseService.registerModel('User', User);
    DatabaseService.registerModel('Session', Session);
  ...
  async listSessions() {
    ...
    const SessionModel = DatabaseService.getModel('Session');
    const UserModel = DatabaseService.getModel('User');
    
    const sessions = await DatabaseService.findMany(SessionModel, {});
    const users = await DatabaseService.findMany(UserModel, {});
  ...
  async clearAllSessions() {
    ...
    // Delete all sessions
    const result = await DatabaseService.deleteMany(SessionModel, {});
  ...
  async clearUserSessions(userEmail) {
    ...
    const user = await DatabaseService.findOne(UserModel, { email: userEmail });
    if (!user) {
    ...
    const sessions = await DatabaseService.findMany(SessionModel, { userId: user._id });
    ...
    const result = await DatabaseService.deleteMany(SessionModel, { userId: user._id });
