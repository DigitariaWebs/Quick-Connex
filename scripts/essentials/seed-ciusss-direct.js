...
const CIUSSS = mongoose.model('CIUSSS', CIUSSSSchema);

async function seedCIUSSS() {
    try {
        console.log('🔄 Connecting to MongoDB...');
        const mongoUri = "mongodb+srv://arselene:1N0Z11AyVoDqdI1A@cluster0.ym7agwh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
